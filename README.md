...
|---------|---------------|----------|
| [`Box<T>`](https://doc.rust-lang.org/stable/alloc/boxed/struct.Box.html) | *(none)* | Unique ownership |
| [`Arc<T>`](https://doc.rust-lang.org/stable/alloc/sync/struct.Arc.html) | `_arc` | Shared ownership, thread-safe (atomic refcount) |
| [`Rc<T>`](https://doc.rust-lang.org/stable/alloc/rc/struct.Rc.html) | `_rc` | Shared ownership, single-threaded (non-atomic refcount) |
